...
public class BaseFragment extends Fragment {
	...
	protected void OnClickdeListView_112257AM(View v) {
		...
		list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View viewClicked,
				...
				ClaseListView_112257AM clickedItem = MiLista_112257AM
						.get(position);
	...
	private class MyListAdapter_112257AM extends
			ArrayAdapter<ClaseListView_112257AM> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			// Nos aseguramos que tenemos un view con el que trabajar (que no
			// sea nulo)
			View itemView = convertView;
			if (itemView == null) {
				itemView = LayoutInflater.from(getActivity()).inflate(
						R.layout.listview_112257am, null);
				// getActivity().getLayoutInflater(R.layout.listview_112257am,
				// parent, false);

				// getLayoutInflater().inflate(R.layout.listview_112257am,
				// parent, false);

			}

			ClaseListView_112257AM ObjetoActual = MiLista_112257AM
					.get(position);

			// Llenamos el view
			ImageView imageView = (ImageView) itemView
					.findViewById(R.id.imagen_112303AM);
			imageView.setImageResource(ObjetoActual.getIconID());

			// Make:
			TextView makeText = (TextView) itemView
					.findViewById(R.id.textView_112303AM);
